...
class DailyHealthLogController extends Controller
{
     ...
     *             @OA\Property(property="has_clots", type="boolean", description="Legacy presence-only clotting flag; superseded by clots_amount"),
     *             @OA\Property(property="clots_amount", type="string", enum={"none","low","medium","high"}, description="Amount of clotting"),
     ...
     *             @OA\Property(property="vaginal_burning", type="boolean", description="Legacy presence-only flag; superseded by vaginal_burning_intensity"),
     *             @OA\Property(property="vaginal_burning_intensity", type="string", enum={"low","medium","high"}, description="Vaginal burning intensity"),
     *             @OA\Property(property="vaginal_itching", type="boolean", description="Legacy presence-only flag; superseded by vaginal_itching_intensity"),
     *             @OA\Property(property="vaginal_itching_intensity", type="string", enum={"low","medium","high"}, description="Vaginal itching intensity"),
     ...
     *             @OA\Property(property="exercise_type", type="array", @OA\Items(type="string", enum={"walking","running","cycling","gym","yoga","swimming","dance","team_sport","other"}), description="Types of physical activity (can select multiple)"),
     *             @OA\Property(property="exercise_duration", type="integer", example=45, description="Exercise duration in minutes"),
     *             @OA\Property(property="exercise_intensity", type="string", enum={"low","medium","high"}, description="Perceived exercise intensity"),
     *             @OA\Property(property="sexual_activities", type="array", @OA\Items(type="string", enum={"high_desire","protected_intercourse","unprotected_intercourse","no_desire","dryness","burning","pain_during_intercourse","bleeding_after_intercourse","lubricant_use"}), description="During/after intercourse experiences (can select multiple)"),
     *             @OA\Property(property="sexual_desire", type="string", enum={"lower","normal","higher"}, description="Libido relative to the user's baseline"),
     *             @OA\Property(property="intercourse_type", type="string", enum={"protected","unprotected"}, description="Whether intercourse was protected"),
     ...
     *             @OA\Property(property="discharge_color", type="string", enum={"clear","white","yellow","green","gray","pink_bloody"}, description="Vaginal discharge color"),
     ...
     *                 @OA\Property(property="clots_amount", type="array", @OA\Items(type="string"), example={"none","low","medium","high"}),
     *                 @OA\Property(property="appetite_change", type="array", @OA\Items(type="string"), example={"loss","normal","gain"}),
     *                 @OA\Property(property="urination_change", type="array", @OA\Items(type="string"), example={"decrease","increase"}),
     *                 @OA\Property(property="sexual_desire", type="array", @OA\Items(type="string"), example={"lower","normal","higher"}),
     *                 @OA\Property(property="intercourse_type", type="array", @OA\Items(type="string"), example={"protected","unprotected"}),
     *                 @OA\Property(property="discharge_color", type="array", @OA\Items(type="string"), example={"clear","white","yellow","green","gray","pink_bloody"}),
     ...
     *                 @OA\Property(property="exercise_type", type="array", @OA\Items(type="string"), example={"walking","running","cycling","gym","yoga","swimming","dance","team_sport","other"}),
     *                 @OA\Property(property="exercise_intensity", type="array", @OA\Items(type="string"), example={"low","medium","high"}),
