 ...
 * category, searchable by title/excerpt, and appended page by page. Opens as a
 * full sheet, and opens each article as a further sheet on top of itself — so
 * dismissing an article returns the reader to the list, scrolled where they
 * left it.
 *
...
function EmptyState({
  ...
  return (
    <div className="ar-empty">
      ...
      <h3 className="ar-empty-title">{title}</h3>
